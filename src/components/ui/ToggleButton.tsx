...
const ToggleButton = <T extends ValidComponent = 'button'>(props: PolymorphicProps<T, ToggleButtonRootProps<T>>) => {
...
export type { ToggleButtonRootProps as ToggleButtonProps };
export { toggleVariants, ToggleButton };

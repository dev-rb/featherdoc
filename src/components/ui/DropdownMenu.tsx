  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          'z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] animate-content-hide overflow-hidden rounded-md border-border bg-popover p-1 text-popover-foreground shadow-md data-[expanded]:animate-content-show',
          props.class
        )}
        {...rest}
      />
...
const DropdownMenuSubContent = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      class={cn(
        'z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border-border bg-popover p-1 text-popover-foreground shadow-md animate-in',
        props.class
      )}
      {...rest}
    />
